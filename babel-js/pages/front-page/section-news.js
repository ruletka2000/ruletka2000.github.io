...
$(document).ready(function () {
  if (document.querySelector('.section-news .slide-title')) {
    ...
    var titles = document.querySelectorAll('.section-news .slide-title');
    var texts = document.querySelectorAll('.section-news .slide-text');
    var maxH = 0;
    ...
    if (g_isDesktop) {
      ...
      animation.from(".section-news .sub-title", 1, { x: 50, opacity: 0 }, 0).from(".section-news .title", 1, { x: 100, opacity: 0 }, 0).from(".section-news .section-news-slider", 1, { x: '50vw', opacity: 0 }, 0);
