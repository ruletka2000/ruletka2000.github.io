...
(function (global, factory) {
  ...
  var UA = {
    ...
    MONTHS_ABBR: ['', 'Січ', 'Лют', 'Бер', 'Кві', 'Тра', 'Чер', 'Лип', 'Сер', 'Вер', 'Жов', 'Лис', 'Гру'],
    AM_PM: ['', ''],
    BUTTONS: ['Відміна', 'Зберегти'],
  ...
  WindowDatePicker.createLanguage('ru', RU);
  WindowDatePicker.createLanguage('ua', UA);
